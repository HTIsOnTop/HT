...
local synapsev3 = syn and syn.toast_notification and "V1" or ""
local worldtoscreenpoint = function(pos)
	if synapsev3 == "V1" then 
...
runFunction(function()
    ...
    local arrowAddFunction = function(plr)
        ...
        arrowObject.Image = downloadVapeAsset("HT/assets/ArrowIndicator.png")
		...
		Function = function(callback)
			if callback then
				vapecapeconnection = lplr.CharacterAdded:Connect(function(char)
					task.spawn(function()
						pcall(function() 
							Cape(char, downloadVapeAsset("HT/assets/HTCapeOption.png"))
						end)
					end)
				end)
				if lplr.Character then
					task.spawn(function()
						pcall(function() 
							Cape(lplr.Character, downloadVapeAsset("HT/assets/HTCapeOption.png"))
						end)
					end)
				end
			else
