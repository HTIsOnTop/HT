if shared.VapeExecuted then
	local VERSION = "1"..(shared.VapePrivate and " PRIVATE" or "")
	local baseDirectory = (shared.VapePrivate and "HTprivate/" or "HT/")
	...
	local function downloadVapeAsset(path)
		if not isfile(path) then
			...
			local suc, req = pcall(function() return vapeGithubRequest(path:gsub("HT/assets", "assets")) end)
			if suc and req then
				writefile(path, req)
			else
				return ""
	...
	searchbaricon.Image = downloadVapeAsset("HT/assets/SearchBarIcon.png")
	...
	searchbarshadow.Image = downloadVapeAsset("HT/assets/WindowBlur.png")
	...
	hoverboxshadow.Image = downloadVapeAsset("HT/assets/WindowBlur.png")
	...
	GuiLibrary.SaveSettings = function()
		if loadedsuccessfully then
			writefile(baseDirectory.."Profiles/"..(shared.CustomSaveVape or game.PlaceId)..".HTprofiles.txt", game:GetService("HttpService"):JSONEncode(GuiLibrary.Profiles))
			local WindowTable = {}
			...
			writefile(baseDirectory.."Profiles/"..(game.GameId).."GUIPositions.HTprofile.txt", game:GetService("HttpService"):JSONEncode(WindowTable))
		end
	end
	...
	GuiLibrary.LoadSettings = function(customprofile)
		if identifyexecutor and identifyexecutor():find("ScriptWare") == nil and listfiles then
			for i,v in pairs(listfiles(baseDirectory.."Profiles")) do 
				...
				if (ext and ext:find("HTprofile") and ext:find("txt") == nil) then
		...
		if isfile("HT/Profiles/GUIPositions.HTprofile.txt") and game.GameId == 2619619496 then
			writefile("HT/Profiles/"..(game.GameId).."GUIPositions.HTprofile.txt", readfile("HT/Profiles/GUIPositions.HTprofile.txt"))
			if delfile then delfile("HT/Profiles/GUIPositions.HTprofile.txt") end
		end
		if shared.VapePrivate then
			if isfile("HTprivate/Profiles/"..(game.GameId).."GUIPositions.HTprofile.txt") == false and isfile("HT/Profiles/"..(game.GameId).."GUIPositions.HTprofile.txt") then
				writefile("HTprivate/Profiles/"..(game.GameId).."GUIPositions.HTprofile.txt", readfile("HT/Profiles/"..(game.GameId).."GUIPositions.HTprofile.txt"))
			end
			if isfile("HTprivate/Profiles/"..(shared.CustomSaveVape or game.PlaceId)..".HTprofiles.txt") == false and isfile("HT/Profiles/"..(shared.CustomSaveVape or game.PlaceId)..".HTprofiles.txt") then
				writefile("HTprivate/Profiles/"..(shared.CustomSaveVape or game.PlaceId)..".HTprofiles.txt", readfile("HT/Profiles/"..(shared.CustomSaveVape or game.PlaceId)..".HTprofiles.txt"))
			end
			if isfile("HTprivate/Profiles/"..(GuiLibrary.CurrentProfile == "default" and "" or GuiLibrary.CurrentProfile)..(shared.CustomSaveVape or game.PlaceId)..".HTprofile.txt") == false and isfile("HT/Profiles/"..(GuiLibrary.CurrentProfile == "default" and "" or GuiLibrary.CurrentProfile)..(shared.CustomSaveVape or game.PlaceId)..".HTprofile.txt") then
				writefile("HTprivate/Profiles/"..(GuiLibrary.CurrentProfile == "default" and "" or GuiLibrary.CurrentProfile)..(shared.CustomSaveVape or game.PlaceId)..".HTprofile.txt", readfile("HT/Profiles/"..(GuiLibrary.CurrentProfile == "default" and "" or GuiLibrary.CurrentProfile)..(shared.CustomSaveVape or game.PlaceId)..".HTprofile.txt"))
			end
		end
		local success2, result2 = pcall(function()
			return game:GetService("HttpService"):JSONDecode(readfile(baseDirectory.."Profiles/"..(shared.CustomSaveVape or game.PlaceId)..".HTprofiles.txt"))
		end)
		...
		local success3, result3 = pcall(function()
			return game:GetService("HttpService"):JSONDecode(readfile(baseDirectory.."Profiles/"..(game.GameId).."GUIPositions.HTprofile.txt"))
		end)
		...
		local success, result = pcall(function()
			return game:GetService("HttpService"):JSONDecode(readfile(baseDirectory.."Profiles/"..(GuiLibrary.CurrentProfile == "default" and "" or GuiLibrary.CurrentProfile)..(shared.CustomSaveVape or game.PlaceId)..".HTprofile.txt"))
		end)
	...
	GuiLibrary["SwitchProfile"] = function(profilename)
		...
		if (not isfile(baseDirectory.."Profiles/"..(profilename == "default" and "" or profilename)..(shared.CustomSaveVape or game.PlaceId)..".HTprofile.txt")) then
	...
	GuiLibrary["CreateMainWindow"] = function()
		...
		windowshadow.Image = downloadVapeAsset("HT/assets/WindowBlur.png")
		...
		windowlogo1.Image = downloadVapeAsset("HT/assets/HTitle.png")
		...
		windowlogo2.Image = downloadVapeAsset("HT/assets/HTVersion.png")
		...
		settingswheel.Image = downloadVapeAsset("HT/assets/SettingsWheel1.png")
		...
		discordbutton.Image = downloadVapeAsset("HT/assets/DiscordIcon.png")
		...
		discordbutton.MouseButton1Click:Connect(function()
			...
			task.spawn(function()
				...
				setclipboard("https://discord.com/invite/NUdyQu6p2f")
				task.wait(1)
				hoverbox3:Remove()
			end)
		end)
		...
		settingsexit.Image = downloadVapeAsset("HT/assets/ExitIcon1.png")
		...
		overlaysicon.Image = downloadVapeAsset("HT/assets/TextGUIIcon4.png")
		...
		overlaysexit.Image = downloadVapeAsset("HT/assets/ExitIcon1.png")
		...
		overlaysbutton.Image = downloadVapeAsset("HT/assets/TextGUIIcon2.png")
		...
		windowbackbutton.Image = downloadVapeAsset("HT/assets/BackIcon.png")
		...
		windowGuiLibrary["CreateCustomToggle"] = function(argstable)
			...
			GuiLibrary.ObjectsThatCanBeSaved["HTSettings"..argstable["Name"].."Toggle"] = {["Type"] = "Toggle", ["Object"] = buttontext, ["Api"] = buttonGuiLibrary}
		...
		windowGuiLibrary["CreateDivider2"] = function(text)
			...
			if text then
				...
				arrow.Image = downloadVapeAsset("HT/assets/RightArrow.png")
				arrow.Active = false
				arrow.Parent = button
				...
				windowbackbutton2.Image = downloadVapeAsset("HT/assets/BackIcon.png")
				...
				windowGuiLibrary3["CreateToggle"] = function(argstable)
					...
					buttonarrow.Image = downloadVapeAsset("HT/assets/ToggleArrow.png")
				...
				windowGuiLibrary3["CreateSlider"] = function(argstable)
					...
					slider3.Image = downloadVapeAsset("HT/assets/SliderButton1.png")
		...
		windowGuiLibrary["CreateGUIBind"] = function()
			...
			bindimg.Image = downloadVapeAsset("HT/assets/KeybindIcon.png")
			...
			bindtext2.Image = downloadVapeAsset("HT/assets/BindBackground.png")
			...
			bindbkg.MouseEnter:Connect(function() 
				bindimg.Image = downloadVapeAsset("HT/assets/PencilIcon.png") 
		...
		windowGuiLibrary["CreateColorSlider"] = function(name, temporaryfunction)
			...
			sliderrainbow.Image = downloadVapeAsset("HT/assets/RainbowIcon1.png")
			...
			slider3.BorderSizePixel = 0
			slider3.ZIndex = 2
			slider3.Image = downloadVapeAsset("HT/assets/ColorSlider1.png")
			...
			sliderGuiLibrary["SetValue"] = function(hue, sat, val)
				...
				sat = sat or 0.7
				val = val or 0.9
				slider3.Image = (sliderGuiLibrary["RainbowValue"] and downloadVapeAsset("HT/assets/ColorSlider2.png") or downloadVapeAsset("HT/assets/ColorSlider1.png"))
				sliderrainbow.Image = (sliderGuiLibrary["RainbowValue"] and downloadVapeAsset("HT/assets/RainbowIcon2.png") or downloadVapeAsset("HT/assets/RainbowIcon1.png"))
	...
	GuiLibrary["CreateCustomWindow"] = function(argstablemain)
		...
		expandbutton.Image = downloadVapeAsset("HT/assets/PinButton.png")
		...
		optionsbutton.Image = downloadVapeAsset("HT/assets/MoreButton3.png")
		...
		windowGuiLibrary["CreateCircleWindow"] = function(argstablemain3)
			...
			targeticon.Image = downloadVapeAsset("HT/assets/CircleList"..(argstablemain3["Type"] == "Blacklist" and "Blacklist" or "Whitelist")..".png")
			targeticon.ZIndex = 2
			...
			windowicon.Image = downloadVapeAsset("HT/assets/CircleList"..(argstablemain3["Type"] == "Blacklist" and "Blacklist" or "Whitelist")..".png")
			...
			windowGuiLibrary3["CreateCircleTextList"] = function(argstable)
				...
				textboxbkg.Image = downloadVapeAsset((argstable["Name"] == "ProfilesList" and "HT/assets/TextBoxBKG2.png" or "HT/assets/TextBoxBKG.png"))
				...
				addbutton.Image = downloadVapeAsset("HT/assets/AddItem.png")
				...
				textGuiLibrary["RefreshValues"] = function(tab, tab2)
					...
					for i,v in pairs(textGuiLibrary["ObjectList"]) do
						...
						deletebutton.Image = downloadVapeAsset("HT/assets/AddRemoveIcon1.png")
			...
			--[[windowGuiLibrary3["CreateButton"] = function(argstable)
				...
				buttonimage.Image = downloadHTAsset(argstable["Icon"])
				...
				buttontexticon.Image = downloadHTAsset(argstable["Icon"])
		...
		windowGuiLibrary["CreateDropdown"] = function(argstable)
			...
			expandbutton2.Image = downloadVapeAsset("HT/assets/DownArrow.png")
			...
			drop2.ExpandButton2.Image = downloadVapeAsset("HT/assets/UpArrow.png")
			local thing = Instance.new("Frame")
			thing.Size = UDim2.new(1, 2, 1, 2)
			thing.BorderSizePixel = 0
			thing.Position = UDim2.new(0, -1, 0, -1)
	...
	GuiLibrary["CreateWindow"] = function(argstablemain2)
		...
		expandbutton2.Active = false
		expandbutton2.Size = UDim2.new(0, 9, 0, 4)
		expandbutton2.Image = downloadVapeAsset("HT/assets/UpArrow.png")
		...
		windowGuiLibrary["CreateOptionsButton"] = function(argstablemain)
			...
			button2.Image = downloadVapeAsset("HT/assets/MoreButton1.png")
		...
		--	children2.LayoutOrder = amount
			...
			buttonGuiLibrary["ToggleButton"] = function(clicked, toggle)
				...
				if buttonGuiLibrary["Enabled"] then
					...
					button2.Image = downloadVapeAsset("HT/assets/MoreButton2.png")
			...
			buttonGuiLibrary["CreateTextList"] = function(argstable)
				...
				textboxbkg.Position = UDim2.new(0, 10, 0, 5)
				textboxbkg.ClipsDescendants = true
				textboxbkg.Image = downloadVapeAsset("HT/assets/TextBoxBKG.png")
				textboxbkg.Parent = frame
				local textbox = Instance.new("TextBox")
				textbox.Size = UDim2.new(0, 159, 1, 0)
				textbox.Position = UDim2.new(0, 11, 0, 0)
			...
			buttonGuiLibrary["CreateTargetWindow"] = function(argstablemain3)
				...
				local windowicon = Instance.new("ImageLabel")
				windowicon.Size = UDim2.new(0, 18, 0, 16)
				windowicon.Image = downloadVapeAsset("HT/assets/TargetIcon.png")
				windowicon.ImageColor3 = Color3.fromRGB(200, 200, 200)
				windowicon.ZIndex = 3
				windowicon.Name = "WindowIcon"
				windowicon.BackgroundTransparency = 1
				...
				buttonreturned["NPCs"] = windowGuiLibrary["CreateButton"]({
					...
					["Icon"] = "HT/assets/TargetIcon2.png",
					["IconSize"] = 12,
					["Function"] = function() end,
					["Default"] = false
				})
				buttonreturned["Peaceful"] = windowGuiLibrary["CreateButton"]({
					...
					["Icon"] = "HT/assets/TargetIcon3.png",
					["IconSize"] = 16,
					["Function"] = function() end,
					["Default"] = false
				})
				buttonreturned["Neutral"] = windowGuiLibrary["CreateButton"]({
					...
					["Icon"] = "HT/assets/TargetIcon4.png",
					["IconSize"] = 19,
					["Function"] = function() end,
					["Default"] = false
				})
			...
			buttonGuiLibrary["CreateColorSlider"] = function(argstable)
				...
				sliderexpand.Image = downloadVapeAsset("HT/assets/HoverArrow3.png")
				sliderexpand.Parent = frame
				sliderexpand.MouseEnter:Connect(function()
					sliderexpand.Image = downloadVapeAsset("HT/assets/HoverArrow4.png")
				end)
			...
			buttonGuiLibrary["CreateTwoSlider"] = function(argstable)
				...
				text4.Image = downloadVapeAsset("HT/assets/SliderArrowSeperator.png")
				...
				slider3.BackgroundColor3 = Color3.fromRGB(26, 25, 26)
				slider3.BorderSizePixel = 0
				slider3.Image = downloadVapeAsset("HT/assets/SliderArrow1.png")
	...
	GuiLibrary["CreateWindow2"] = function(argstablemain)
		...
		settingsbutton.Image = downloadVapeAsset("HT/assets/SettingsWheel2.png")
		...
		windowGuiLibrary["CreateColorSlider"] = function(argstable)
			...
			sliderexpand.BackgroundTransparency = 1
			sliderexpand.Position = UDim2.new(0, game:GetService("TextService"):GetTextSize(text1.Text, text1.TextSize, text1.Font, Vector2.new(10000, 100000)).X + 3, 0, 6)
			sliderexpand.Image = downloadVapeAsset("HT/assets/HoverArrow.png")
			sliderexpand.Parent = frame
			sliderexpand.MouseEnter:Connect(function()
				sliderexpand.Image = downloadVapeAsset("HT/assets/HoverArrow2.png")
			end)
			sliderexpand.MouseLeave:Connect(function()
				sliderexpand.Image = downloadVapeAsset("HT/assets/HoverArrow.png")
			end)
	...
	GuiLibrary["CreateNotification"] = function(top, bottom, duration, customicon)
		...
		image.Image = downloadVapeAsset("HT/assets/NotificationBackground.png")
		...
		frame2.ZIndex = 2
		frame2.Image = downloadVapeAsset("HT/assets/NotificationBar.png")
		frame2.BorderSizePixel = 0
		frame2.Parent = image
		local icon = Instance.new("ImageLabel")
		icon.Name = "IconLabel"
		icon.Image = downloadVapeAsset(customicon and "HT/"..customicon or "HT/assets/InfoNotification.png")
